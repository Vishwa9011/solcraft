...
export type CreateTokenParams = Pick<CreateTokenInput, 'name' | 'symbol' | 'supply' | 'decimals' | 'uri'>;
...
export async function buildMintTokensInstruction(signer: TransactionSigner, { mint, amount }: MintTokensParams) {
