...
export const WITHDRAW_FROM_FAUCET_DISCRIMINATOR = new Uint8Array([
  210, 45, 219, 228, 136, 215, 104, 111,
]);

export function getWithdrawFromFaucetDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    WITHDRAW_FROM_FAUCET_DISCRIMINATOR,
  );
}
...
> {
  return combineCodec(
    getWithdrawFromFaucetInstructionDataEncoder(),
    getWithdrawFromFaucetInstructionDataDecoder(),
  );
}
...
> {
  ...
  return Object.freeze({
    ...
    data: getWithdrawFromFaucetInstructionDataEncoder().encode(
      args as WithdrawFromFaucetInstructionDataArgs,
    ),
    programAddress,
...
>(
  ...
  return {
    ...
    data: getWithdrawFromFaucetInstructionDataDecoder().decode(
      instruction.data,
    ),
  };
}
